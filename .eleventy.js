...
const { imageShortcode, imageWithClassShortcode, imagePathShortcode } = require('./config');
...
module.exports = function (config) {
  ...
  config.addLiquidShortcode('image_path', imagePathShortcode);
