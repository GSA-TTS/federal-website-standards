...
The meta description supports accessibility and discoverability. The meta description will often appear in search results pages instead of a snippet of page content. The description, along with the [HTML page title](/standards/html-page-title.md), helps a person decide whether or not to click a search result.
